<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['basicdata:courseinfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['basicdata:courseinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['basicdata:courseinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['basicdata:courseinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="courseinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科目ID" align="center" prop="courseId" />
...
<script>
import { listCourseinfo, getCourseinfo, delCourseinfo, addCourseinfo, updateCourseinfo, exportCourseinfo } from "@/api/basicdata/courseinfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除科目信息编号为"' + courseIds + '"的数据项？').then(function() {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有科目信息数据项？').then(() => {
        this.exportLoading = true;
        return exportCourseinfo(queryParams);
      }).then(response => {
